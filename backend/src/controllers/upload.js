...
// Middleware upload multiple ảnh cho thumbnails và ảnh phụ
...
// Middleware upload chỉ ảnh phụ (không bắt buộc)
export const uploadAdditionalImages = upload.fields([
    { name: 'additionalImages', maxCount: 5 }
]);

// Middleware upload linh hoạt (có thể có hoặc không có file)
export const uploadFlexible = upload.any();
